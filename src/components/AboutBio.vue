<template functional>
  <section class="about-bio" :key="aboutBio">
    <h3>who i am</h3>
    <div class="about-bio__container">
      <div class="about-bio__container__left">
        <p class="p--first">
          My name is Lisa. I have a bachelors degree in Computer Science from
...
.about-bio {
  @include subpage-section-wrapper;
